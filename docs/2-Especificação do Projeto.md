...
|**Marina Silva**|           |                             | 
|-------------------|-----------|-----------------------------|
<img src="img/marina.jpg/" width="200" height="200"/>|**Idade:** 29 anos. **Naturalidade:** Taubaté - São Paulo. **Ocupação:** Analista de marketing.       |**Atribuições:** Planejamento e execução de campanhas de marketing digital, análise de dados e métricas de desempenho, além de gerenciamento de conteúdo nas redes sociais da empresa..
